// src/components/dashboard-supervisor/charts/ResumoStatusChart.tsx
...
interface ResumoStatusChartProps {
  data: { label: string; total: number }[];
}

export function ResumoStatusChart({ data }: ResumoStatusChartProps) {
  return (
